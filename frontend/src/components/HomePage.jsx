                      ...
                      {['Intake', 'Review', 'Filed', 'Discovery', 'Trial', 'Judgment'].map((phase, i) => (
                        <React.Fragment key={i}>
                          <div style={{ 
                            flex: 1,
                            padding: '4px 6px',
                            background: i <= 3 ? 'var(--primary-light)' : 'var(--glass)',
                            border: `1px solid ${i <= 3 ? 'var(--primary-rim)' : 'var(--rim)'}`,
                            borderRadius: 5,
                            textAlign: 'center',
                            fontSize: 9,
                            color: i <= 3 ? '#93c5fd' : 'var(--text-4)',
                      ...
                      {[
                        ...
                        <div key={i} style={{ 
                          ...
                          <div style={{ 
                            ...
                            border: `1.5px solid ${t.done ? 'var(--primary)' : 'var(--text-4)'}`,
                          ...
                          <span style={{ 
                            fontSize: 8, 
                            color: t.due === 'Today' ? '#f87171' : 'var(--text-4)',
                            flexShrink: 0
                          }}>
                            {t.due}
                          </span>
                        ...
                        <div key={i} style={{ 
                          ...
                          <div style={{ position: 'relative', flexShrink: 0 }}>
                            ...
                            <div style={{ 
                              ...
                              background: member.status === 'online' ? '#34d399' : '#fbbf24',
              ...
              <ul className="lm-benefits">
                {[
                  ...
                  },
                  {
                    ...
                    d: "Real-time collaboration with role-based access, comments, and activity feeds.",
                  },
                  {
                    ico: "📊",
                    t: "Progress tracking",
                    d: "Visual workflows with drag-and-drop stages, milestone tracking, and status dashboards.",
                  },
                  {
                    ico: "💰",
                    t: "Billing integration",
                    d: "Log time directly from matter pages. Auto-generate invoices tied to matter milestones.",
                  },
                ].map((b, i) => (
            ...
            <div className="lm-reveal">
              ...
              <ul className="lm-benefits">
                {[
                  {
                    ico: "⚖️",
                    t: "Court Hearing Sync",
                    d: "Auto-import cause lists and court schedules. Color-coded by court and matter type.",
                  },
                  {
                    ico: "⏰",
                    t: "Smart Reminders",
                    d: "Multi-channel alerts — email, SMS, and in-app — delivered at the right time before every event.",
                  },
                  {
                    ico: "📅",
                    t: "Multiple Views",
                    d: "Month, week, and agenda views. Switch between them seamlessly to plan your week.",
                  },
                  {
                    ico: "🚫",
                    t: "Blocked Dates",
                    d: "Block dates for vacations, firm closures, or personal unavailability. Prevent scheduling conflicts.",
                  },
                ].map((b, i) => (
                  <li key={i} className="lm-benefit">
                    <div className="lm-benefit-ico">{b.ico}</div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2, marginBottom: 10 }}>
                    ...
                    {[
                      ...
                      <div key={i} style={{
                        ...
                        border: day.current ? '1px solid var(--primary)' : '1px solid transparent',
                        position: 'relative'
                      }}>
                  ...
                  <div style={{ borderTop: '1px solid var(--rim)', paddingTop: 10 }}>
                    ...
                    {[
                      ...
                      <div key={i} style={{
                        ...
                        padding: '8px 0', borderBottom: i < 3 ? '1px solid var(--rim)' : 'none'
                      }}>
