...
import { useDataFetch } from "../hooks/useDataFetch"; // Add this import
import TaskReviewModal from "./TaskReviewModal"; // Add this import
...
const TaskDashboardCard = ({ tasks, userId, onTaskUpdate }) => {
  ...
  const { dataFetcher } = useDataFetch(); // Initialize data fetch hook
  ...
  const calculateStats = (taskList) => ({
    ...
    pendingReview: taskList.filter((task) => task.status === "under-review")
      .length,
  ...
  const getActionMenu = (task) => {
    ...
    // Add submit for review option for assignees
    ...
    // Add review option for task givers
    ...
    // Add edit option for task creators
    if (canEdit) {
      items.push({
        key: "edit",
        icon: <EditOutlined />,
      ...
      <Card
        title={
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge
                count={assignedStats.pendingReview}
                size="small"
                color="orange"
                style={{ backgroundColor: "#fa8c16" }}
                title="Tasks pending your review"
              />
              <Badge
                ...
                <div className="mt-2 flex items-center justify-between">
                  <div className="text-xs">
                    ...
                    <span className="text-orange-600">
                      {myStats.pendingReview} in review
                    </span>
                    <span className="text-gray-400 mx-1">•</span>
              ...
              <div className="bg-white p-3 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="mt-2 flex items-center justify-between">
                  <div className="text-xs">
                    ...
                    <span className="text-gray-400 mx-1">•</span>
                    <span className="text-orange-600">
                      {assignedStats.pendingReview} in review
                    </span>
                    <span className="text-gray-400 mx-1">•</span>
                    <span className="text-red-600">
                              ...
                              {canSubmitForReview(task) && (
                                <Tooltip title="Submit for Review">
                                  <Button
                                    ...
                                    size="small"
                                    icon={
                                      <SendOutlined className="text-blue-500 hover:text-blue-700" />
                                    }
                                    onClick={() =>
                                      handleSubmitForReview(task._id)
                                    }
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center gap-4">
                  <span className="text-xs font-medium text-gray-600">
                    {currentStats.total} task
                    {currentStats.total !== 1 ? "s" : ""}
                  </span>
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    {currentStats.pendingReview > 0 && (
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-orange-600">
                          {currentStats.pendingReview} in review
                        </span>
                      </div>
                    )}
                    <div className="flex items-center gap-1">
