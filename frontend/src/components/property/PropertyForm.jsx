  ...
  useEffect(() => {
    if (initialValues) {
      const formattedValues = {
        ...
        consentStatus: initialValues.governorsConsent?.status || "not-required",
        consentApplicationDate: initialValues.governorsConsent?.applicationDate
        ...
        consentApprovalDate: initialValues.governorsConsent?.approvalDate
          ...
          : null,
        consentReferenceNumber: initialValues.governorsConsent?.referenceNumber,
        ...
        // Development
        developmentApplicable: initialValues.development?.isApplicable || false,
        developmentCostAmount: initialValues.development?.estimatedCost?.amount,
        developmentCostCurrency:
          initialValues.development?.estimatedCost?.currency || "NGN",
        developmentCompletionDate: initialValues.development?.expectedCompletion
          ? dayjs(initialValues.development.expectedCompletion)
          : null,
        planningPermitStatus: initialValues.development?.planningPermit?.status,
        planningPermitDate: initialValues.development?.planningPermit
          ?.approvalDate
          ? dayjs(initialValues.development.planningPermit.approvalDate)
          : null,
        buildingPermitStatus: initialValues.development?.buildingPermit?.status,
        ...
        ? {
            contractOfSale: {
              ...
              ...(values.contractOfSaleExecutionDate && {
                executionDate: values.contractOfSaleExecutionDate.toISOString(),
              }),
      ...
      development: {
        ...
        ...(values.developmentApplicable && {
          ...
          ...(values.developmentCompletionDate && {
            expectedCompletion: values.developmentCompletionDate.toISOString(),
          }),
        }),
      },
    };
      ...
      <Tabs activeKey={activeTab} onChange={setActiveTab} className="mb-6">
        ...
        <Tabs.TabPane tab="Basic Information" key="basic">
          ...
          <Card title="Financial Information" className="mb-6">
            <Tabs type="card">
              <Tabs.TabPane tab="Purchase Price" key="purchase">
                <Row gutter={16}>
                  <Col xs={24} md={16}>
              ...
              <Tabs.TabPane tab="Rent Amount" key="rent">
                <Row gutter={16}>
                  <Col xs={24} md={12}>
              ...
              <Tabs.TabPane tab="Security Deposit" key="deposit">
                <Row gutter={16}>
                  <Col xs={24} md={16}>
        ...
        {/* PARTIES TAB */}
        <Tabs.TabPane tab="Parties" key="parties">
          <Card title="Vendor/Owner" className="mb-6">
            <Row gutter={16}>
              <Col xs={24} md={12}>
                <Form.Item name="vendorName" label="Vendor Name">
                  <Input placeholder="Enter vendor/owner name" size="large" />
                </Form.Item>
              </Col>
              <Col xs={24} md={12}>
                <Form.Item name="vendorContact" label="Contact Information">
                  <Input placeholder="Phone, email, or address" size="large" />
                </Form.Item>
              </Col>
            </Row>
          </Card>
          ...
          <Card title="Purchaser/Buyer" className="mb-6">
            <Row gutter={16}>
              ...
              <Col xs={24} md={12}>
                <Form.Item name="purchaserContact" label="Contact Information">
                  <Input placeholder="Phone, email, or address" size="large" />
                </Form.Item>
              </Col>
            </Row>
          ...
          <Card title="Lease Parties (If Applicable)" className="mb-6">
            <Row gutter={16}>
              ...
              <Col xs={24} md={12}>
                <Form.Item name="landlordContact" label="Contact Information">
                  <Input placeholder="Phone, email, or address" size="large" />
                </Form.Item>
              </Col>
              <Col xs={24} md={12}>
        ...
        {/* LEGAL DOCUMENTS TAB */}
        <Tabs.TabPane tab="Legal Documents" key="legal">
        ...
        {/* DUE DILIGENCE TAB */}
        <Tabs.TabPane tab="Due Diligence" key="diligence">
